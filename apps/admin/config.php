<?php
	...
	return [	
	    'view_replace_str'       => [
            ...
            '__CSS__'    =>  \think\request::instance()->root() . '/theme/default/admin/resources/css',
            '__JS__'     =>  \think\request::instance()->root() . '/theme/default/admin/resources/js',
            '__IMG__'    =>  \think\request::instance()->root() . '/theme/default/admin/resources/img', 
        ],
        'template'               => [
            // 模板引擎类型 支持 php think 支持扩展
            'type'         => 'Think',
            // 模板路径
            'view_path'    => './theme/default/admin/',
            // 模板后缀
            'view_suffix'  => 'html',
            // 模板文件名分隔符
            'view_depr'    => DS,
