...
function apiArray($code = 1,$message='success',$content='',$data=''){
	...
	return ['code'=>$code,'message'=>$message,'data'=>$data,'content'=>$content];
}
...
function send_mail($tomail, $name, $subject = '', $body = '', $attachment = null) {
    ...
    $mail->SetFrom(config('email.replyemail'), config('email.replyuser'));
    $replyEmail = config('email.replyemail');                   //留空则为发件人EMAIL
