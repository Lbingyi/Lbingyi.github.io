    ...
    public function index() { //充值
        ...
        if (input('?get.data') && input('get.data')) {
            ...
            if ($username) {
                ...
                Db::name('card') -> where('card_number', $cardnumber) -> where('appid', $appid) -> update(['use_name'=>'用户:'.$username,'sales_time'=>time(),'sales_status'=>2]);
            ...
            if ($acard) {
                ...
                $salestime=time();                           
                Db::name('card') -> where('card_number', $cardnumber) -> where('appid', $appid) -> update(['uid'=>$uid,'use_name'=>'授权:'.$acard,'sales_time'=>$salestime,'sales_status'=>2]);
