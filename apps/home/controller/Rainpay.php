...
class Rainpay extends controller {
    public function _initialize(){
		...
		$titles='';
		if($vurl=='home/Index') $titles='首页';
		if($vurls=='app/Goods/goodslist') $titles='-产品商店';
		if($vurl=='home/Login') $titles='-登录';
		if($vurl=='home/Order') $titles='-我的订单';
		if($vurl=='home/Register') $titles='-注册';
		if($vurl=='home/Repwd') $titles='-修改密码';
		if($vurl=='home/User') $titles='-用户资料';
		if($vurl=='home/Score') $titles='-我的积分';
		if($vurl=='app/UserAcard') $titles='-我的授权码';
		if($vurl=='app/UserCard') $titles='-我的充值卡';
